...
- brand: 브랜드명 (예: 
        ...
        '티파니앤코', '퍼퓸 드 말리', '펜할리곤스', '프라다', '프레데릭 말'ect
    ])
- concentration: '솔리드 퍼퓸', '엑스트레 드 퍼퓸', '오 드 뚜왈렛', '오 드 코롱', '오 드 퍼퓸', '퍼퓸'ect
- day_night_score: ["day", "night"]
- gender: ['Female', 'Male', 'Unisex', 'unisex ']
- season_score: ['winter', 'spring', 'summer', 'fall']
- sizes: 용량 (30ml, 50ml, 100ml 등) 단위는 무시하고 숫자만,['30', '50', '75', '100', '150' 중 하나]
