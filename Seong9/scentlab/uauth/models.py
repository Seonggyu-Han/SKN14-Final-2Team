...
class UserDetail(models.Model):
    ...
    # Canonical display name for the user (full name)
    name = models.CharField(max_length=60, blank=True, null=True)

    # Optional demographics used by the app
    ...
    # Profile image URL (e.g., S3 object URL)
    ...
    def avatar_url(self) -> str:
        """Return profile image URL with cache-busting, or default image."""
