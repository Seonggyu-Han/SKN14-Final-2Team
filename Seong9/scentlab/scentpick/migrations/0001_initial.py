    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('top_notes', models.CharField(blank=True, max_length=300, null=True)),
                ('middle_notes', models.CharField(blank=True, max_length=300, null=True)),
                ('base_notes', models.CharField(blank=True, max_length=300, null=True)),
